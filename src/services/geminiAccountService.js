...
const OAUTH_PROVIDERS = {
  [OAUTH_PROVIDER_GEMINI_CLI]: {
    ...
    clientSecret: process.env.GEMINI_OAUTH_CLIENT_SECRET || 'GEMINI_OAUTH_CLIENT_SECRET_PLACEHOLDER',
  ...
  [OAUTH_PROVIDER_ANTIGRAVITY]: {
    ...
    clientId:
      ...
      'ANTIGRAVITY_OAUTH_CLIENT_ID_PLACEHOLDER',
    clientSecret:
      process.env.ANTIGRAVITY_OAUTH_CLIENT_SECRET || 'ANTIGRAVITY_OAUTH_CLIENT_SECRET_PLACEHOLDER',
    scopes: [
